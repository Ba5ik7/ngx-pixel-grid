...
PixelCanvasComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: PixelCanvasComponent, selectors: [["pixel-canvas"]], decls: 2, vars: 0, template: function PixelCanvasComponent_Template(rf, ctx) { if (rf & 1) {
        i0.ɵɵelementStart(0, "p");
        i0.ɵɵtext(1, "pixel-canvas works!");
        i0.ɵɵelementEnd();
    } }, changeDetection: 0 });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(PixelCanvasComponent, [{
        type: Component,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(NgxPixelCreatorModule, { declarations: [NgxPixelCreatorComponent,
